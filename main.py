...
@app.route('/')
def home():
    return "I am 👿 ANONYMOUS 👿 HOSTING BOT"
...
TOKEN = os.getenv('8792786597:AAGtw3nWs6KTpPVuICpPbjh5HWIfyDGK_F8')
OWNER_ID = int(os.getenv('OWNER_ID', 8411182293))
ADMIN_ID = int(os.getenv('ADMIN_ID', 8411182293))
YOUR_USERNAME = os.getenv('YOUR_USERNAME', 'ANONYMOUS_0990')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'MASH0990')
